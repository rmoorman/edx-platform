...
class LearnerProfilePage(FieldsMixin, PageObject):
    ...
    def _upload_file(self, filename):
        ...
        self.browser.execute_script('$(".upload-button-input").change();')
        ...
        self.q(css='.u-field-textarea').first.click()
        self.wait_for_ajax()
    ...
    def image_upload_success(self):
        ...
        return 'image.jpg' in image_link[0] if image_link else False
    ...
    def profile_image_message(self):
        ...
        self.wait_for_field('image')
        self.wait_for_ajax()
        return self.q(css='.message-banner p').text
